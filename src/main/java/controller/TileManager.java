...
public class TileManager implements Drawable {
    ...
    public ArrayList<Tile> levelOneTiles;
    public ArrayList<Tile> levelTwoTiles;
    ...
    public TileManager(GamePanel gamePanel) {
        ...
        levelOneTiles = new ArrayList<>();
        levelTwoTiles = new ArrayList<>();
...
//            }
            for (int i = 0; i < 6; i++) {
                g.drawImage(tiles[1].image, 412 + (48 * i) - xLvlOffset, 311, 48, 48, null);
            }
